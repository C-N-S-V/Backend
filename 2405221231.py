...
def data():
    ...
    try:
        while True:
            ...
            # Correct for offsetUnboundLocalError: local variable 't_prev' referenced before assignment
            ...
            return ("AngleX_1 = %.2f, AngleY_1 = %.2f, AngleZ_1 = %.2f, AngleX_2 = %.2f, AngleY_2 = %.2f, AngleZ_2 = %.2f" %
                    (AngleX, AngleY, AngleZ, AngleX_2, AngleY_2, AngleZ_2))
